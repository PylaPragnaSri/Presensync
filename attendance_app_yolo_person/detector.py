...
def process_first_n_seconds(video_path, model, seconds=5, subsample_every_n_frames=1, save_proof_dir=PROOF_DIR, start_time_sec=0.0, conf_thresh=0.6, imgsz=640):
                ...
                if hasattr(res, "boxes"):
                    for box in res.boxes:
                        ...
                        if len(xyxy) >= 4:
                            ...
                            # Filter small detections here
                            if (x2 - x1) * (y2 - y1) < 5000:  # adjust threshold
